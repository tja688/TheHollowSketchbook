...
{
    /// <summary>
    /// Enemy visual view. StS IntentView dependency removed.
    /// BOUNDARY: Retained as a generic creature view (HP bar, hit reactions, death fade).
    /// Can be reused for any Creature (enemy or player) in the grid-based system.
    /// </summary>
