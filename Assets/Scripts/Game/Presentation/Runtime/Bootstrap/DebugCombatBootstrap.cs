...
{
    /// <summary>
    /// Debug bootstrap. StS StarterContentRegistry dependency removed.
    /// BOUNDARY: Content registration must be done by the new content system before calling StartPrototypeRun.
    /// </summary>
    public sealed class DebugCombatBootstrap : MonoBehaviour
    {
        ...
        {
            // BOUNDARY: Content models (Character, Act, etc.) must be registered in ModelDb
            // by the new content initialization system before this call.
